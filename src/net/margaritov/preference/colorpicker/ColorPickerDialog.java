...
public class ColorPickerDialog extends Dialog implements ColorPickerView.OnColorChangedListener,
    ...
    private void setUp(int color) {
        ...
        mOldColor.setColor(Color.BLACK);
        mAutoColor.setColor(Color.TRANSPARENT);
    ...
    private void updateHexValue(int color) {
        if (getAlphaSliderVisible()) {
            mHexVal.setText(ColorPickerPreference.convertToARGB(color).toUpperCase(
                    Locale.getDefault()));
        } else {
            mHexVal.setText(ColorPickerPreference.convertToRGB(color).toUpperCase(
                    Locale.getDefault()));
        }
        mHexVal.setTextColor(mHexDefaultTextColor);
    }
    ...
    public void onClick(View v) {
        ...
        } else if (v.getId() == R.id.auto_color_panel) {
            if (mListener != null) {
                mListener.onColorChanged(mAutoColor.getColor());
            }
        } else {
            if (mListener != null) {
