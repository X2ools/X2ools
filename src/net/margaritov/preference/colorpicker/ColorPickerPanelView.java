...
public class ColorPickerPanelView extends View {
    ...
    public ColorPickerPanelView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ColorPickerDialog);
        mText = a.getString(R.styleable.ColorPickerDialog_text);
        a.recycle();
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(mText, getWidth() / 2 - textWidth / 2, getHeight() / 2 + 18, mTextPaint);
