...
public class X2oolsApplication extends Application {
    ...
    public static String X2OOLS_DIR = Environment.getExternalStorageDirectory() + "/X2ools/";

    public static String X2OOLS_PREFS = Environment.getExternalStorageDirectory()
            + "/X2ools/" + "prefs.json";

    @Override
    public void onCreate() {
        X2OOLS_DIR = Environment.getExternalStorageDirectory() + "/X2ools/";
        X2OOLS_PREFS = Environment.getExternalStorageDirectory()
                + "/X2ools/" + "prefs.json";
        initX2oolsDir();
