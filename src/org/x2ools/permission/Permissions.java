...
public class Permissions {
    ...
    public static void handleLoadPackage(final LoadPackageParam lpparam) throws Throwable {
        ...
        Class<?> classActivityManagerService = XposedHelpers.findClass(
                CLASS_ActivityManagerService, lpparam.classLoader);
        ...
        XposedHelpers.findAndHookMethod(classPackageManagerService, "checkUidPermission",
                String.class, int.class, new XC_MethodReplacement() {
        ...
        if (DEBUG_PROTECTED_BROADCAST) {
            ...
            Method method = XposedHelpers.findMethodBestMatch(classActivityManagerService,
                    "broadcastIntentLocked", classProcessRecord,// 0
                    String.class, // 1
                    Intent.class,// 2
                    String.class,// 3
            ...
            XposedHelpers.findAndHookMethod(classActivityManagerService, "broadcastIntentLocked",
                    ...
                    new XC_MethodHook() {
                        ...
                        protected void beforeHookedMethod(MethodHookParam param) throws Throwable {
                            ...
                            XposedBridge.log(intent.getAction() + "\n callingUid : " + callingUid
                                    ...
                                    + "\n persistent : "
                                    + fieldPersistent.getBoolean(processRecordObject));
        ...
        if (!DEBUG_PROTECTED_BROADCAST) {
            XposedHelpers.findAndHookMethod(classPackageManagerService, "isProtectedBroadcast",
