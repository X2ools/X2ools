...
public class SuperDebug {
    ...
    public static void handleLoadPackage(LoadPackageParam lpparam) throws Throwable {
        final String packageInfo =  "package : " + lpparam.packageName + "  process: " + lpparam.processName;
        XposedBridge.log(packageInfo);
        
        Class<?> phoneWindowClz = XposedHelpers.findClass(CLASS_PhoneWindow, lpparam.classLoader);        
        XposedHelpers.findAndHookMethod(phoneWindowClz, "onWindowFocusChanged", boolean.class,  new XC_MethodHook() {
