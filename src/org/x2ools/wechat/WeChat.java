...
public class WeChat {
	...
	public static void handleLoadPackage(final LoadPackageParam lpparam) throws Throwable {
		...
		Class<?> settingsAboutSystemUI = XposedHelpers.findClass(CLASS_SETTINGS_ABOUT_SYSTEM_UI, lpparam.classLoader);
		...
		XposedHelpers.findAndHookMethod(settingsAboutSystemUI, "Bn", new XC_MethodHook() {
			...
			protected void afterHookedMethod(MethodHookParam param) throws Throwable {
				Class<?> preferenceClz = XposedHelpers.findClass(CLASS_PREFERENCE, lpparam.classLoader);
				Class<?> preferenceTitleCategoryClz = XposedHelpers.findClass(CLASS_PREFERENCE_TITLE_CATEGORY,
						lpparam.classLoader);
				Object preference = preferenceClz.getConstructor(Context.class).newInstance(param.thisObject);
				Object preferenceTitleCategory = preferenceTitleCategoryClz.getConstructor(Context.class).newInstance(
						param.thisObject);
